...
static constexpr uint32_t WebMidiChannelPayloadLength = 1u;
...
private:
    ...
    {
        if (sysexLength != WebMidiChannelPayloadLength + 6u)
            return;
        ...
        uint8_t channel = sysexBuffer[6] & 0x0Fu;
