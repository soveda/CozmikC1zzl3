...
testing the Web MIDI/SysEx path. The `build-no-picotool` fallback is useful for
compile verification and produces ELF/BIN/HEX artifacts, but not UF2 output.
