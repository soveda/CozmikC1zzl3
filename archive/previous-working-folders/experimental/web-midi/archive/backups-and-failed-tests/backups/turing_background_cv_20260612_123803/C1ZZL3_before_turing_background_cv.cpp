...
public:
    ...
    void ProcessSample() override
    {
        ...
        if (mode != Switch::Up)
        {
            ...
            CVOut1(heldTuringCv);
            CVOut2(heldTuringModCv);
            PulseOut1(heldTuringPulse);
            PulseOut2(heldTuringAltPulse);
...
private:
    ...
    void holdTuringOutputs()
    {
        heldTuringCv = turingCv;
        heldTuringModCv = turingModCv;
        heldTuringPulse = turingPulse;
        heldTuringAltPulse = turingAltPulse;
    }
...
private:
    ...
    int32_t heldTuringCv = 0;
    int32_t heldTuringModCv = 0;
    ...
    bool heldTuringPulse = false;
    bool heldTuringAltPulse = false;
