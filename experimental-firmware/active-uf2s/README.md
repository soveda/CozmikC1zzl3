...
| `C1ZZL3_GNARLY_DUAL_OSCILLATOR_UI_PROTOCOL_V10.uf2` | `C1ZZL3 Gnarly`: first hardware-UI experiment with switch-up for oscillator 1, switch-middle for oscillator 2, switch-down hold for oscillator 2 base interval/ring/noise plus save, and no Turing CV/pulse/MIDI output. | `experiments/full-dual-oscillators/` |
